...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(108.242055,22.849621);//定义一个中心点坐标
...
map.addControl(scaleCtrl);
    ...
    //标注点数组
    var markerArr = [{title:"广西民族大学",content:"计算机20级网络工程",point:"112.681497|26.884444",isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
         ];
    //创建marker
    function addMarker(){
